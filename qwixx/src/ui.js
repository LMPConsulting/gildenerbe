...
function renderKopplung() {
  ...
  if (k.schritt === 'moment') {
    app.innerHTML = `<div class="screen"><div class="wrap">
      ...
      <p class="lead">Verbindungsdaten werden vorbereitet. Falls nach der Kamera gefragt wird: erlauben — ohne die Freigabe finden sich die Handys im Hotspot nicht.</p></div></div>`;
    return;
  }
  ...
  if (k.schritt === 'warten') {
    app.innerHTML = `<div class="screen"><div class="wrap">
      ...
      <p class="lead">Dauert es länger als ein paar Sekunden, schaut auf die Zeile darunter: Steht dort
