...
function kopplungNeu() {
  const rolle = ui.kopplung?.rolle || 'gastgeber';
  ui.funk?.schliessen();
  ui.funk = null;
  kopplungStarten(rolle);
}
...
function renderKopplung() {
  ...
  if (k.schritt === 'kamera') {
    app.innerHTML = `<div class="screen"><div class="scroll"><div class="blatt">
      ...
      <div style="margin-top:20px;display:flex;flex-direction:column;gap:10px">
        <button class="btn btn--messing" id="kameraNochmal">Nochmal fragen</button>
  ...
  if (k.schritt === 'warten') {
    app.innerHTML = `<div class="screen"><div class="scroll"><div class="blatt">
      ...
      <div class="hinweis" style="margin-top:16px">Dauert es länger als ein paar Sekunden, sagt die Zeile darunter, woran es liegt.</div>
