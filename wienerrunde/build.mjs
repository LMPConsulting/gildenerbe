// Baut aus wienerrunde/src/* eine einzige, in sich geschlossene HTML-Datei.
// Kein CDN, keine externen Dateien: läuft per Doppelklick (file://) und offline.
//
//   node wienerrunde/build.mjs            -> wienerrunde/index.html
//   node wienerrunde/build.mjs --fragment out.html   (Rumpf ohne <html>/<head>, für Artifacts)
...
const MODULE = ['src/qr.js', 'src/funk.js', 'src/netz.js',
  'src/brett.js', 'src/geometrie.js', 'src/engine.js', 'src/ui.js'];
...
// Ein Brettausschnitt mit Farbband und Haus.
const ICON = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">`
  + `<rect width="64" height="64" rx="14" fill="#221a24"/>`
  + `<rect x="8" y="8" width="48" height="48" rx="8" fill="#f4ece0"/>`
  + `<rect x="8" y="8" width="48" height="11" rx="8" fill="#b5323f"/>`
  + `<rect x="8" y="14" width="48" height="5" fill="#b5323f"/>`
  + `<rect x="18" y="28" width="12" height="12" rx="2" fill="#4f9d69"/>`
  + `<rect x="34" y="28" width="12" height="12" rx="2" fill="#2e7d6b"/>`
  + `<rect x="18" y="44" width="28" height="6" rx="3" fill="#c9b8a3"/></svg>`;
const iconUrl = 'data:image/svg+xml,' + encodeURIComponent(ICON);

const manifest = {
  name: 'Wiener Runde', short_name: 'Wiener Runde', start_url: '.', display: 'standalone',
  orientation: 'portrait', background_color: '#221a24', theme_color: '#221a24',
  description: 'Wiener Runde — kaufen, bauen, Miete kassieren. Komplett offline.',
...
<meta name="theme-color" content="#221a24">
<meta name="color-scheme" content="dark">
<meta name="mobile-web-app-capable" content="yes">
<meta name="apple-mobile-web-app-capable" content="yes">
<meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">
<meta name="description" content="Wiener Runde – Straßenkaufspiel für zwei mit Wiener Orten. An einem Handy oder auf zweien, komplett offline.">
<title>Wiener Runde</title>
...
const body = `<div id="app"></div>\n<script id="wienerrunde-js">\n${script}\n</script>`;

const page = `<!doctype html>
<html lang="de">
<head>
${kopf}
<style id="wienerrunde-css">
${css}
</style>
</head>
<body>
...
if (webFlagge !== -1) {
  ...
  const mitnahme = 'WienerRunde.html';
...
if (fragmentFlag !== -1) {
  const out = resolve(process.argv[fragmentFlag + 1] || 'wienerrunde-fragment.html');
  writeFileSync(out, `<title>Wiener Runde</title>\n<style id="wienerrunde-css">\n${css}\n</style>\n${body}\n`);
